...
export const PROJECTS = [
  ...
  {
    title: "Collab: Video calling app",
    image: project2,
    description:
      "A video calling application that enables users to connect with each other .",
    technologies: ["NextJS", "Tailwind CSS  and Firebase.", "Shadcn", "Firebase"],
  },
